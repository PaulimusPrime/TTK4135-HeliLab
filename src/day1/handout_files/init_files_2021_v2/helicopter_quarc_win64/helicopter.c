 ...
 * C source code generated on : Thu Jan 30 11:40:07 2025
 *
...
void helicopter_output(void)
{
   ...
   *  Sum: '<S5>/Sum3'
   */
  rtb_Clock = ((helicopter_P.pitch_ref_Value - helicopter_B.Gain1[2]) *
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (2804940081U);
  helicopter_M->Sizes.checksums[1] = (1686977098U);
  helicopter_M->Sizes.checksums[2] = (3418730569U);
  helicopter_M->Sizes.checksums[3] = (3516230812U);
